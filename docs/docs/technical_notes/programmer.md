...
!!! tip "Use it now"
    You can access this programmer directly in your browser, without downloading or building anything: **[Open the KXUSBC2 Programmer](https://manuelkasper.github.io/kxusbc2/programmer/)**

    This programmer is based on the more generic [WebUPDI](https://github.com/manuelkasper/webupdi).

![Screenshot](/images/programmer-ui.png)
